...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_tyv to login script."
...
# the current dir:
if   test x${GTLANG_tyv} = x ; then
	echo "WARNING: The variable \${GTLANG_tyv} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_tyv} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_tyv} has the value:"
	echo "  ${GTLANG_tyv}"
